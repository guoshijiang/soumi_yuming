...
<div id="tuijian" class="tuijiao" >
	<div class="main">
		<div class="top">
			<img src="<?php echo (IMG_HOME_URL); ?>12.png" height="65"><span>一口价域名</span><img src="<?php echo (IMG_HOME_URL); ?>jiao.png" height="65">
		</div>
			...
			<ul>
			  <?php if(is_array($info1)): foreach($info1 as $key=>$v): ?><li>
					...
					<div class="price">
						...
						<h3><a href="<?php echo u('User/price',array('yuming_id'=>$v['yuming_id']));?>">报价</a></h3>
					</div>
...
<input type='hidden' id='yikoutotal' value='<?php echo ($yikoutotal); ?>' />
    ...
    $(function(){
    	(function() {
            ...
            if(typeof info_cache[page_index] === 'undefined'){ 
		      $.ajax({
		       url:"/index.php/home/Index/yikouyuming",
