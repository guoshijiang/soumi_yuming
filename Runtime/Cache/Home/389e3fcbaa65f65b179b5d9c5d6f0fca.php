...
<div id="jiaoyi" class="tuijiao" >
	<div class="main">
		<div class="top">
			<img src="<?php echo (IMG_HOME_URL); ?>14.png" height="65"><span>交易案例</span><img src="<?php echo (IMG_HOME_URL); ?>jiao.png" height="65">
		</div>
			...
			<ul>
			   <?php if(is_array($info1)): foreach($info1 as $key=>$v): ?><li>
					...
					<div class="price">
						...
						<p style="text-decoration: line-through;">价格：￥<?php echo ($v["yuming_xiaoshou_price"]); ?></p>
						<h3>已出售</h3>
					</div>
...
<input type='hidden' id='jiaoyitotal' value='<?php echo ($jiaoyitotal); ?>' />
    ...
    $(function(){
    	(function() {
            ...
            if(typeof info_cache[page_index] === 'undefined'){ 
		      $.ajax({
		       url:"/index.php/home/Index/jiaoyiyuming",
