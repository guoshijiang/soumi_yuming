...
<head>
  ...
  <title>域名交易,优质域名,议价域名,域名出售 - soumi.com</title>
    ...
    <div class="main">
      ...
      <div class="nav_left fl" style="height: 90px;" >
        <ul>
          ...
          <li><a href="/index.php/Home/Index/find">域名查找</a></li>
      ...
      <div class="ss fr">
        <form action="/index.php/Home/Index/whois" method="post">
          <input type="text" name="yumingname" style="width: 180px;" placeholder="请输入域名，如：soumi.com" /><input class="btn" type="submit" value="whois查询" />
        </form>
      </div>
    </div>
   </div>
...
<div id="tuijian" class="tuijiao" >
	<div class="main">
		<div class="top">
			<img src="<?php echo (IMG_HOME_URL); ?>11.png" height="65"><span>您可能还对下面的域名感兴趣</span><img src="<?php echo (IMG_HOME_URL); ?>jiao.png" height="65">
		</div>
		<div class="bottom"  id="houzhuiinfo_table">
			<ul>
			  <?php if(is_array($ls_ids)): foreach($ls_ids as $key=>$v): ?><li>
					<h4><?php echo ($v["yuming_name"]); ?></h4>
					<div class="price">
						<p><?php echo ($v["yuming_introduce"]); ?></p>
						<p>价格（万）：￥<?php echo ($v["yuming_xiaoshou_price"]); ?></p>
...
<script type="text/javascript">
	alert('报价成功！若价格合适，我司工作人员会尽快联系您！感谢您对搜米的支持！')
</script>
<!-- 推荐结束 -->
