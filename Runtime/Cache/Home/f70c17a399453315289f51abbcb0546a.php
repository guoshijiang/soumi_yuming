...
<!-- 导航结束 -->
<link rel="stylesheet" type="text/css" href="<?php echo (CSS_HOME_URL); ?>tuijiao.css">
<!-- 推荐开始 -->
<div id="tuijian" class="tuijiao" >
	<div class="main">
		<div class="top">
			<img src="<?php echo (IMG_HOME_URL); ?>11.png" height="65"><span>推荐域名</span><img src="<?php echo (IMG_HOME_URL); ?>jiao.png" height="65">
		</div>
			...
			<ul>
			  <?php if(is_array($info1)): foreach($info1 as $key=>$v): ?><li>
					...
					<div class="price">
						...
						<p>价格：￥<?php echo ($v["yuming_xiaoshou_price"]); ?></p>
...
<input type='hidden' id='tuijiantotal' value='<?php echo ($tuijiantotal); ?>' />
<script type="text/javascript">
 var info_cache = new Array();
    $(function(){
    	(function() {
		    var num_entries = $("#tuijiantotal").val();
		    //alert(num_entries);
		    // 创建分页
            ...
            if(typeof info_cache[page_index] === 'undefined'){ 
		      $.ajax({
		       url:"/index.php/home/Index/tuijianyuming",
		       ...
		       //console.log(msg);
		           var s = "";
		                  $.each(msg,function(n,v){
		                  	s +='<ul><li><h4>'+v.yuming_name+'</h4><div class="price"><p>'+v.yuming_introduce+'</p><p>价格：<strong>￥'+v.yuming_xiaoshou_price+'</strong></p><h3><a href="/index.php/Home/User/price/yuming_id/'+v.yuming_id+'/cat_id/'+v.cat_id+'">报价</a></h3></div></li></ul>';
		                     });
