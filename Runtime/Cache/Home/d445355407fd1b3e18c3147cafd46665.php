...
<!-- 导航结束 -->
<link rel="stylesheet" type="text/css" href="<?php echo (CSS_HOME_URL); ?>login.css">
<!-- 登录开始 -->
	<div id="login">
		<div class="left fl">
			<form  name="login" action="/index.php/home/user/login" method="post">
				<div>
					<label for="username"><img src="<?php echo (IMG_HOME_URL); ?>login1.png"></label>
					<input type="text" class="txt" id="username" placeholder="用户名" name="user_name" value="<?php echo ($userregister[0]); ?>"/>
				</div>
				<div>
					<label for="password"><img src="<?php echo (IMG_HOME_URL); ?>login2.png"></label>
					<input type="password" class="txt" id="password" name="user_pwd" value="<?php echo ($userregister[2]); ?>" placeholder="密码" />
					<br/>
				</div>
				<input type="submit" id="btnl" value="登录" />
			</form>
			<p><a href="<?php echo U('User/register');?>">没有账号？立即注册</a> <a href="<?php echo U('yanzhengpwd');?>" style="margin-left: 135px;">忘记密码</a></p>
		</div>
		<div class="right fr">
			<img src="<?php echo (IMG_HOME_URL); ?>weima.jpg" height="180">
		</div>
	</div>
<!-- 登录结束 -->
