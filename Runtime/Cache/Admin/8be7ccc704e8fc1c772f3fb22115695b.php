...
<script type="text/javascript" src='<?php echo (PLUGIN_URL); ?>ueditor/lang/zh-cn/zh-cn.js'></script>
  <tr>
    <td>
    <form action="/index.php/Admin/Yuming/tianjia" method="post">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          ...
          <?php if(is_array($houzhuiinfo)): foreach($houzhuiinfo as $key=>$v): ?><option name="<?php echo ($v["houzhui_id"]); ?>" value='<?php echo ($v["houzhui_id"]); ?>'><?php echo ($v["houzhui_name"]); ?></option><?php endforeach; endif; ?>
          </select>
        </div></td>
      </tr>
      <tr>
